      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-navy mb-2">60-90 Days</div>
              <p className="text-gray-600">Typical Timeline</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-navy mb-2">$500-1,500</div>
              <p className="text-gray-600">Court Costs</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-navy mb-2">Both Agree</div>
              <p className="text-gray-600">Key Requirement</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-navy mb-2">Less Stress</div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Mutual Agreement</strong>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Faster Process</strong>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Lower Cost</strong>
            ...
            <div className="bg-light-blue/10 p-8 rounded-2xl">
              <h3 className="text-2xl font-semibold text-navy mb-6">Benefits of Uncontested Divorce</h3>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-navy mb-6">Agreement Required On:</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Property Division</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Child Custody & Parenting Time</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Child Support</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Spousal Maintenance</strong>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-semibold text-navy mb-6">Basic Eligibility:</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Arizona Residency</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Irretrievable Breakdown</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">No Domestic Violence</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-navy">Full Disclosure</strong>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-start gap-6 p-6 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-navy mb-3">Reach Agreement</h3>
            ...
            <div className="flex flex-col md:flex-row items-start gap-6 p-6 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-navy mb-3">Prepare Documents</h3>
                <p className="text-gray-700">
            ...
            <div className="flex flex-col md:flex-row items-start gap-6 p-6 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-navy mb-3">Wait 60 Days</h3>
                <p className="text-gray-700">
            ...
            <div className="flex flex-col md:flex-row items-start gap-6 p-6 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-navy mb-3">Finalize Divorce</h3>
                <p className="text-gray-700">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/practice-areas/divorce/contested" className="block bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-xl font-semibold text-navy mb-3">Contested Divorce</h3>
            ...
            <Link href="/practice-areas/financial/property-division" className="block bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-xl font-semibold text-navy mb-3">Property Division</h3>
              <p className="text-gray-600 mb-4">
